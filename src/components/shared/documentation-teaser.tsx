  ...
  return (
    <div className="relative overflow-hidden border-t border-border/40">
      ...
      <div className="absolute inset-0 -z-10">
        <div className="absolute top-0 z-[-1] h-full w-full bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(120,119,198,0.1),rgba(255,255,255,0))]" />
        <div className="absolute inset-0 bg-grid-white/10 [mask-image:radial-gradient(white,transparent_70%)] dark:bg-grid-dark/10" />
      </div>
